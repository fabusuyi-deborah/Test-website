...
const CommunityPartnerships = () => {
  return (
    <section className='bg-gray-50 py-16 px-4 lg:py-20 xl:py-24'>
      <div className='max-w-6xl mx-auto'>
        <div className='flex flex-col lg:flex-row items-center gap-8 lg:gap-12 xl:gap-16'>
          ...
          <div className='flex-1 text-center lg:text-left'>
            ...
            <p className='text-lg lg:text-xl xl:text-2xl text-gray-600 mb-8 lg:mb-10 max-w-2xl lg:max-w-none'>
            ...
            <button className='bg-blue-500 hover:bg-blue-600 text-white font-semibold px-8 py-4 lg:px-10 lg:py-5 xl:px-12 xl:py-6 rounded-xl lg:rounded-2xl text-lg lg:text-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg'>
              Contact us
            </button>
          </div>
